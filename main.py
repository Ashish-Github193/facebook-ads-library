...
from utils.utils_extras import get_headers_for_saving_data, write_list_of_dicts_to_csv, change_date_format
...
def scrape_and_write_data(driver, iteration_count, total_iterations_count, chunk_of_advertiser_data, date_started_in, filename):
...
def scrape_data_with_inputs(country_code, ad_type, search_query):
    ...
    while check_if_start_is_bigger(start_date=start_date_max_itr, end_date=END_DATE):
        ...
        logging.info(f"Scraping data from date: {start_date_min_itr} to date: {start_date_max_itr}", end="\n\n")
        ...
        while iteration_count < total_iterations_count:
            ...
            iteration_count = scrape_and_write_data(driver, iteration_count, total_iterations_count,
                                                    chunk_of_advertiser_data, start_date_min_itr, filename)
...
if __name__ == "__main__":
    ...
    scrape_data_with_inputs(country_code=country_code, ad_type=ad_type, search_query=search_query)