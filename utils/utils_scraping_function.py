...
def hover_element_if_exists (driver: webdriver.Chrome, element: WebElement, xpath: str , info_block_constructor_xpath: str):
...
def hover_element( driver: webdriver.Chrome, element: WebElement, xpath: str ):    
    ...
    try: return hover_element_if_exists( driver, element, xpath, info_block_constructor_xpath )
    except Exception: return None


def find_company_name_element_xpath(parent_element: WebElement, parent_element_xpath: str):
